module.exports = function (app) {
  ...
  app.controller('AppCtrl', function($scope, $ionicModal, $timeout, $rootScope, $state, $ionicHistory, $cordovaSocialSharing, ImageUploadService, SQLiteService, $cordovaCamera, $ionicSideMenuDelegate, $ionicPlatform, $filter, APIs, $window, $ionicPopover, $cordovaBarcodeScanner, $cordovaSplashscreen, $ionicActionSheet) {
  
    SQLiteService.addSqLiteUserTable().then(function(result) {
                    
    });
    
    SQLiteService.addSqLiteUserSettingsTable().then(function(result) {
    ...
    $scope.open = function(item) {
      ...
      /*if ((typeof $rootScope.sitem.json_metadata === 'string' || $rootScope.sitem.json_metadata instanceof String) && $rootScope.sitem.json_metadata) {
        $rootScope.sitem.json_metadata = angular.fromJson($rootScope.sitem.json_metadata);
      }*/
      setTimeout(function() {
              ...
              if (dd) {
                ...
                if ($scope.loginData.password) {
                  ...
                  SQLiteService.removeUserSettingsSql().then(function(removeResult) {
                    SQLiteService.addUserSettingsSql().then(function(result) {
    ...
    $scope.logout = function() {
      ...
      SQLiteService.removeUserSql().then(function(result) {});
      SQLiteService.removeUserSettingsSql().then(function(result) {});
  ...
  app.controller('PostsCtrl', function($scope, $rootScope, $state, $ionicPopup, $ionicPopover, $interval, $ionicScrollDelegate, $ionicModal, $filter, $stateParams, $ionicSlideBoxDelegate, $ionicActionSheet, $ionicPlatform, $cordovaCamera, ImageUploadService, SQLiteService, $filter, $ionicHistory, APIs, $translate, $compile) {
  ...
  //epostsctrl
  //spostctrl
  app.controller('PostCtrl', function($scope, $stateParams, $rootScope, $interval, $ionicScrollDelegate, $ionicModal, $filter, $ionicActionSheet, $cordovaCamera, $ionicPopup, ImageUploadService, SQLiteService, $ionicPlatform, $ionicSlideBoxDelegate, $ionicPopover, $filter, $state, APIs, $ionicHistory, $ionicPosition, $cordovaFileTransfer, $ionicLoading, $translate, $ionicBody) {
  ...
  //sprofilectrl
  app.controller('ProfileCtrl', function($scope, $stateParams, $rootScope, $ionicActionSheet, $cordovaCamera, ImageUploadService, SQLiteService, $ionicPopup, $ionicSideMenuDelegate, $ionicHistory, $state, APIs, $ionicPopover, $filter, $ionicModal, $ionicBody) {
  ...
  app.controller('ActivityCtrl', function($scope, $rootScope, APIs, $stateParams, $ionicNavBarDelegate){
    $scope.filter = {activity: 'votes'};
    $scope.activities=[{name:'Votes', value:'votes' },{name:'Mentions',value:'mentions'},{name:'Follows',value:'follows'},{name:'Reblogs',value:'reblogs'},{name:'Leaderboard',value:'leaderboard'},{name:'Achievements',value:'achievements'}];
